...
node {
 ...
 stage ('build') {
   ...
   writeFile (encoding: 'UTF-8', file: 'settings.xml', text: '<settings><localRepository>/tmp</localRepository><servers><server><id>InternalSnapshots</id><username>admin</username><password>admin123</password></server></servers></settings>')
